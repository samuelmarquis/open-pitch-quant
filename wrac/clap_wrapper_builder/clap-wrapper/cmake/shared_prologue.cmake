...
if (ANY_WASM_TOOLCHAIN)
    set(CLAP_WRAPPER_PLATFORM "EMS" CACHE STRING "Clap Wrapper Platform: WebAssembly")
elseif (APPLE)
...
function(guarantee_clap_wrapper_shared)
    ...
    if (TARGET fmt-header-only)
        message(STATUS "clap-wrapper: fmt-header-only is an existing target; using that for clap-wrapper")
        target_link_libraries(clap-wrapper-shared-detail PUBLIC fmt-header-only)
    else()
